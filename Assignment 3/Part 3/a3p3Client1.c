...
void loopcmd(){
  ...
  outFile.open("a3p3Client1.log", std::ios_base::app);
  outFile << "------------------------------------------------------" << std::endl;
...
int main(int argc, char **argv) 
{
 ...
 while (loopcount < 8) {
	...
	char *cmdList[3] = {"date", "ls -l junk.txt", "touch junk.txt"};
 ...
 loopcount = loopcount + 1;
  sleep2();
 } //Closing bracket for while loop (up to 8 times as described above).
